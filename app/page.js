        ...
        <div className="container px-4 mx-auto">
          ...
          <div className="flex flex-wrap justify-center">
            ...
            <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
              <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105 text-center">
                <p className="text-gray-600 dark:text-gray-400">
                  &quto;This service has been a game-changer for our business. Highly
                  recommend!&quto;
                </p>
            ...
            <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
              <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105 text-center">
                <p className="text-gray-600 dark:text-gray-400">
                &quto;Amazing experience! The team was professional and the results
                  were outstanding.&quto;
                </p>
                <h3 className="mt-4 text-xl font-semibold text-gray-800 dark:text-gray-200">
                  Jane Smith
                </h3>
            ...
            <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
              <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105 text-center">
                <p className="text-gray-600 dark:text-gray-400">
                &quto;Exceptional service and support. We couldn*apos;t be happier with
                  the results.&quto;
                </p>
                <h3 className="mt-4 text-xl font-semibold text-gray-800 dark:text-gray-200">
                  Michael Brown
              ...
              <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-2 text-gray-600 dark:text-gray-400">
                    Very Nice and Informative C Programming Blog. you should see it. 
                  </p>
            ...
            <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
              <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-2 text-gray-600 dark:text-gray-400">
                    ChatGPT vs Gemini. 2 AI Bots both are very good but there are some issues with both the bots. See in the blog 
                  </p>
                  <Button className="m-2" variant="outline">
            ...
            <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
              <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-2 text-gray-600 dark:text-gray-400">
                    This is a Blog Made for Beginners to learn CSS easily. This Blog is made by Harry
                  </p>
                  <Button className="m-2" variant="outline">
